...
describe('Cálculo de Probabilidade de Gols no Campeonato Inglês', () => {
    ...
    beforeEach(() => {
        cy.visit('https://www.espn.com.br/futebol/calendario/_/liga/eng.1', {timeout: 300000});

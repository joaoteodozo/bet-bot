...
describe('Cálculo de Probabilidade de Gols no Campeonato Espanhol', () => {
    ...
    beforeEach(() => {
        cy.visit('https://www.espn.com.br/futebol/calendario/_/liga/esp.1', {timeout: 300000});

...
describe('Cálculo de Probabilidade de Gols no Campeonato Português', () => {
    ...
    beforeEach(() => {
        cy.visit('https://www.espn.com.br/futebol/calendario/_/liga/por.1', { timeout: 300000 });
    });
